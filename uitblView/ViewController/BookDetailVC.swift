...
class DetailVC: UIViewController {
    ...
    func setupBindings(){
        ...
        btnBookmark.addTarget(self, action: #selector(onTapBookmarkDetail), for: .touchUpInside)
    ...
    private func refreshUI(){
        ...
        if data.isBookmark{
            btnBookmark.setImage(.init(systemName: "bookmark.fill"), for: .normal)
        }else{
            btnBookmark.setImage(.init(systemName: "bookmark"), for: .normal)
        }
    }
